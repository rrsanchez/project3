...
//////////////////////////////////////////////////
 ...
 while (i <= dayAmount){
    ...
    if (  (i == day) && (month == current.getMonth() ) && (year == current.getFullYear())  ){
        padding +="<td height='50' class='currentday' bgcolor=\"#d9d9d9\" onMouseOver='this.style.background=\"#989898\"; this.style.color=\"#000000\"' onMouseOut='this.style.background=\"#D9D9D9\"; this.style.color=\"#000000\"' button id=\"btn"+i+"\" class=\"button_current_day\"  onclick =\"addRow("+i+")\"><font color='gray'>"+i+"</font><ul id=\"ul_"+i+"\"></ul></td>";
    }else{
